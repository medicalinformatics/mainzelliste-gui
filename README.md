  ...
  "patientLists": [
    {
      ...
      "fields": [
        { "i18n": "first_name_text", "name": "Vorname", "mainzellisteField": "vorname", "semantic": "FIRSTNAME" },
          ...
          { "i18n": "birth_name_text", "name": "Geburtsname", "mainzellisteField": "geburtsname", "semantic": "BIRTH_NAME"},
          ...
          { "i18n": "zip_code_text", "name": "PLZ", "mainzellisteField": "plz", "semantic": "POSTAL_CODE"}
      ],
      "debug": false,
      "betaFeatures": {
        "consent": false,
