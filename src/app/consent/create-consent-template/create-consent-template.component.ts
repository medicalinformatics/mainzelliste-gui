...
export class CreateConsentTemplateComponent implements OnInit {
  ...
  public template: ConsentTemplate = {items: [], validity: {day: 0, month: 0, year: 0}, policy: "2.16.840.1.113883.3.1937.777.24.2.1790"};
  ...
  createTemplate() {
    this.consentService.addConsentTemplate(this.mapConsentTemplate(this.template)).then( t =>
